  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-4">
      ...
      {cards && cards.length > 0 && (
        <div className="mb-4">
          <p className="text-sm text-gray-600 mb-2">{t('strategy.cards.in.hand')}</p>
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-4 mb-4 rounded">
        <h4 className="font-semibold text-blue-800 mb-2">{t('strategy.scenario')}</h4>
        <p className="text-blue-700 text-sm">{scenario}</p>
      </div>

      <div className="bg-green-50 border-l-4 border-green-500 p-4 rounded">
        <h4 className="font-semibold text-green-800 mb-2">{t('strategy.solution')}</h4>
